...
Fully compatible with Spring Boot 4. For earlier version support check the compatibility table below.
...
- CHANGE: Upgraded Spring Boot version to 4.0.2
- CHANGE: Upgraded Java version to 21
- CHANGE: Upgraded Testcontainers to 2.x
