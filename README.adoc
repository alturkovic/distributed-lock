...
Add the BOM dependency under `<dependencyManagement>`:
...
<dependencyManagement>
  <dependencies>
    <dependency>
      ...
      <version>[insert release version here]</version>
      <scope>import</scope>
      <type>pom</type>
    </dependency>
  </dependencies>
...
Add the dependency that you need under `<dependencies>`, for an example, if you want a Redis lock:
