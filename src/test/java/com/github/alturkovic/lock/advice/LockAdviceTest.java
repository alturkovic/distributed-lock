...
public class LockAdviceTest {
    ...
    public void shouldAcquireLockAndCallMethod() {
        when(lock.acquire(anyListOf(String.class), any(), any(), anyLong(), anyLong(), anyLong())).thenReturn("abc");
    ...
    public void shouldNotAcquireLockAndThrowException() {
        when(lock.acquire(anyListOf(String.class), any(), any(), anyLong(), anyLong(), anyLong())).thenReturn(null);
